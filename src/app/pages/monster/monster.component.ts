...
import { DeleteMonsterConfirmationDialogueComponent } from '../../components/delete-monster-confirmation-dialogue/delete-monster-confirmation-dialogue.component';
...
export class MonsterComponent implements OnInit, OnDestroy {
	...
	deleteMonster() {
		const dialogRef = this.dialog.open(DeleteMonsterConfirmationDialogueComponent);
